...
You can use [`?lang=test`](https://scpwiki.github.io/timer/timer-selector.html?lang=test) to see what the messae keys for each part of the UI are, to aid in translation.
